export function generateDefaultGesrestHtml(productName: string = "GESREST"): string {
  ...
  return `
<!-- PÁGINA 1: PORTADA -->
<div class="a4-page-sheet" style="min-height: 1050px; position: relative; padding: 60px 50px; background: #ffffff; margin: 0 auto 30px auto; box-shadow: 0 4px 15px rgba(0,0,0,0.12); page-break-after: always;">
